...
const TryNow = () => {
  ...
  return (
    <div className="relative mt-10 p-10 min-h-screen bg-gradient-to-br from-indigo-50 via-pink-50 to-purple-100 overflow-hidden">
      {/* Blurred blobs */}
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <SignedIn>
          {/* Prompt Inputs (only when signed in) */}
          <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-xl border border-white/30 flex flex-col items-center gap-4">
            ...
            >
              <option value="ghibli">tile-texture ✨</option>
              <option value="realistic">cinematic 🌄</option>
        ...
        <SignedOut>
          ...
          <div className="bg-white/70 p-6 mt-10 rounded-3xl shadow-md text-gray-700 text-lg font-medium">
            Please <span
              onClick={() => openSignIn()}
              className="text-indigo-600 cursor-pointer underline hover:text-indigo-800"
            >sign in</span> to generate AI images.
          </div>
        </SignedOut>
